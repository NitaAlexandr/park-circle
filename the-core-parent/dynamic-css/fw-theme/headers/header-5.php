...
.header-5 .fw-menu-open i.fa {
  font-size: <?php echo esc_js($the_core_less_variables['fw-header-5-menu-icon-size']); ?>;
  line-height: <?php echo esc_js($the_core_less_variables['fw-header-5-menu-icon-height']); ?>;
  color: <?php echo esc_js($the_core_less_variables['fw-header-5-menu-icon-color']); ?>;
}
.header-5 .fw-menu-open:hover i.fa {
  color: <?php echo esc_js($the_core_less_variables['fw-header-5-menu-icon-color-hover']); ?>;
}
/* Menu Styling */
.header-5 .mm-panels,
