...
<div class="fw-row">
	<?php if( !empty($btn) ) :
		...
		<div class="fw-col-sm-12 field-submit <?php echo esc_attr($button_alignment); ?>">
			<button type="submit" class="fw-btn <?php echo ( $btn['full_width']['selected_type'] != 'default' ) ? esc_attr( $btn['full_width']['selected_type'] ) : ''; ?> <?php echo esc_attr($btn_size_class); ?> <?php the_core_button_class( $style ); ?>" style="<?php echo $btn_size_style; ?>">
				<span>
