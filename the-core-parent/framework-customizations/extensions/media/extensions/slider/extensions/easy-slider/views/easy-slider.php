			...
			<?php foreach ( $data['slides'] as $id => $slide ): $the_core_count ++; ?>
				...
				<li data-easy-slider="<?php echo esc_attr($the_core_count); ?>" class="fw-easy-slider-item">
					<div class="fw-block-image-parent">
						<a href="<?php echo esc_url($link); ?>" class="fw-block-image-child fw-ratio-container fw-ratio-16-9 <?php echo $extra_class; ?>"><?php echo $image['img']; ?></a>
					</div>
					<?php if( !empty($slide['title']) ) : ?>
						<a href="<?php echo esc_url($link); ?>" class="fw-easy-slider-title <?php echo $extra_class; ?>"><?php echo $slide['title']; ?></a>
					<?php endif; ?>
				</li>
			<?php endforeach; ?>
		</ul>
