...
$options            = array(
	...
	'image_moving' => array(
		...
		'picker'  => array(
			'selected' => array(
				'type'         => 'switch',
				'label'        => __( 'Image Moving', 'the-core' ),
				'value'        => 'no',
				'right-choice' => array(
					'value' => 'yes',
					'label' => __( 'Yes', 'the-core' ),
		...
		'choices' => array(
			'yes' => array(
				'animation' => array(
					'label' => __( '', 'the-core' ),
					'desc'  => __( 'Select the moving animation', 'the-core' ),
					'type'  => 'short-select',
					'value' => 'fw-image-vertical-moving',
					'choices' => array(
						'fw-image-vertical-moving'   => __( 'Vertical Moving', 'the-core' ),
						'fw-image-horizontal-moving' => __( 'Horizontal Moving', 'the-core' ),
						'fw-image-tossing-moving'    => __( 'Tossing Moving', 'the-core' ),
						'fw-image-zoom-moving'       => __( 'Zoom Moving', 'the-core' )
					),
				),
				'hover_only' => array(
					'type'         => 'switch',
