...
/*----------------End Animation----------------*/
?>
<div class="panel-group fw-accordion <?php echo esc_attr( $atts['class'] ); ?> tf-sh-<?php echo esc_attr( $atts['unique_id'] ); ?>" <?php echo $data_animation; ?> id="<?php echo $id; ?>" role="tablist" aria-multiselectable="true">
