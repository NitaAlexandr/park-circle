...
if ( $atts['special_divider']['selected_value'] == 'text' || $atts['special_divider']['selected_value'] == 'icon' || $atts['special_divider']['selected_value'] == 'custom' ) :
	...
	?>
	<div <?php echo $link_id; ?> class="fw-divider fw-divider-special tf-sh-<?php echo esc_attr( $atts['unique_id'] ); ?> <?php echo esc_attr( $atts['class'] ); ?> <?php echo esc_attr( $atts['type'] ); ?> <?php echo esc_attr( $size ); ?> <?php echo esc_attr( $position ); ?> <?php echo esc_attr( $divider_size ); ?> <?php echo $divider_bg_class; ?> <?php echo $divider_icon_class; ?>" <?php echo $data_animation; ?> <?php echo 'style="' . $width . ' ' . $custom_spacing . '"'; ?> >
