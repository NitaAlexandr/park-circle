...
if( $member_type == 'fw-team-member-type-2' ) : ?>
	<div class="fw-team tf-sh-<?php echo esc_attr( $atts['unique_id'] ); ?> <?php echo esc_attr( $atts['class'] ); ?> <?php echo $member_type; ?> fw-overlay-1" <?php echo $data_animation; ?>>
...
<?php else: ?>
	<div class="fw-team tf-sh-<?php echo esc_attr( $atts['unique_id'] ); ?> <?php echo esc_attr( $atts['class'] ); ?> <?php echo $member_type; ?>" <?php echo $data_animation; ?>>
		<?php if( !empty($image) ) : ?>
			<div style="<?php echo $style; ?>" class="fw-team-image fw-block-image-parent <?php echo esc_attr( $atts['round_image'] ); echo esc_attr($parent_class); ?>">
