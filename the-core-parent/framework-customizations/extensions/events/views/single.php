							...
							<?php if ( isset( $options['event_children'] ) ) : $the_core_count = 0; ?>
								...
								<?php foreach ( $options['event_children'] as $key => $row ) : ?>
									...
									<ul class="details-event">
										...
										<li><b><?php esc_html_e( 'End', 'the-core' ) ?>:</b> <?php echo date_i18n( $final_date_format, strtotime( $row['event_date_range']['to'] ) ); ?></li>
							...
							<div class="fw-row fw-location-info">
								...
								<div class="fw-col-sm-5 fw-event-offers" itemprop="offers" itemscope itemtype="http://schema.org/Offer">
									...
									<?php if( !empty($event_options['ticket_link']) ) : ?>
										<span itemprop="priceCurrency" content="<?php echo $general_events_options['events_currency_text']; ?>">
