...
//    'title'        => array(
//        'label'   => __( 'Set the area title', 'the-core' ),
//        'desc'    => __( 'set the title above the grid', 'the-core' ),
//        'type'    => 'text',
//        'value'   => '',
//    ),
//    'sub_title'        => array(
//        'label'   => __( 'Set the area sub title', 'the-core' ),
//        'desc'    => __( 'set the sub title above the grid', 'the-core' ),
//        'type'    => 'text',
//        'value'   => '',
//    ),
	'blog_type'       => array(
    ...
    'bottom_url'        => array(
        'label'   => __( 'Set the bottom url', 'the-core' ),
        'desc'    => __( 'set the url for the bottom blue button', 'the-core' ),
        'type'    => 'text',
        'value'   => '',
    ),
