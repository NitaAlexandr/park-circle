	...
	'testimonials-group' => array(
		...
		'options' => array(
			...
			'testimonials'          => array(
				...
				'label'         => __( 'Slides', 'the-core' ),
				'popup-title'   => __( 'Add/Edit Testimonial', 'the-core' ),
				'desc'          => __( 'Here you can add, remove and edit your slides.', 'the-core' ),
				'type'          => 'addable-popup',
				'size'          => 'medium',
//				'template'      => '{{=author_name}}',
				'popup-options' => array(
					'content'       => array(
						'label'   => __( 'Text Slideds', 'the-core' ),
					...
					'slide_link' => array(
						...
						'desc'  => __( 'Add an link to this slide', 'the-core' ),
						'type'  => 'text',
					),
//					'author_name'   => array(
//						'label' => __( 'Name', 'the-core' ),
